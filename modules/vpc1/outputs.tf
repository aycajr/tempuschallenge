...
output "vpc1_default_network_acl_id" {
...
output "vpc1_private_subnets_cidr_blocks" {
...
/*
# VPC Endpoints
output "vpc1_endpoint_s3_id" {
  description = "The ID of VPC endpoint for S3"
  value       = "${element(concat(aws_vpc1_endpoint.s3.*.id, list("")), 0)}"
}

output "vpc1_endpoint_s3_pl_id" {
  description = "The prefix list for the S3 VPC endpoint."
  value       = "${element(concat(aws_vpc1_endpoint.s3.*.prefix_list_id, list("")), 0)}"
}

output "vpc1_endpoint_dynamodb_id" {
  description = "The ID of VPC endpoint for DynamoDB"
  value       = "${element(concat(aws_vpc1_endpoint.dynamodb.*.id, list("")), 0)}"
}
